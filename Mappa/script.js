...
var markerAM = L.marker([45.478482, 11.609105],
    ...
    .bindPopup('Alessandro Michelazzo è qui <br> <img src="dist/assets/Ale.jpg" class="immagine"></img>');

var markerAF = L.marker([45.525638, 11.564612],
    {alt: 'Vicenza'}).addTo(map) 
    .bindPopup('Alberto Fanchin è qui <br> <img src="radioactive.jpg" class="immagine"></img>');

var markerAD = L.marker([45.505693, 11.414956],
    {alt: 'Vicenza'}).addTo(map) 
    .bindPopup('Alessandro Dandea è qui <br> <img src="radioactive.jpg" class="immagine"></img>');
